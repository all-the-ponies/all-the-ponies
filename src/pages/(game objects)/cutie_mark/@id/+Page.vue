...
const basePrice = computed(() => {
    const result = {
        token: cutie_mark.value.price?.token,
        tokens: null,
        currency: cutie_mark.value.price?.base.currency,
        price: cutie_mark.value.price?.base.amount,
        dailyGoals: cutie_mark.value.price?.daily_goals,
    }
